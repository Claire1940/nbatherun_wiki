...
export default function HomePageClient({
  ...
  const externalLinks = {
    ...
    steamCommunity: 'https://steamcommunity.com/app/2866670',
    discord: 'https://discord.gg/qZH3A6wcER',
    x: 'https://x.com/nbatherun',
    playtest: 'https://nbatherun.firstlook.gg/',
    youtube: 'https://www.youtube.com/watch?v=DvgJugUaKWQ',
  }
  ...
  const structuredData = {
    ...
    '@graph': [
      ...
      },
      {
        ...
        name: 'NBA The Run',
        alternateName: 'NBA THE RUN',
        url: siteUrl,
        description:
          'Community guide hub for NBA THE RUN release updates, gameplay explainers, and official resource links.',
        logo: {
          '@type': 'ImageObject',
        ...
        sameAs: [
          ...
          externalLinks.steamStore,
          externalLinks.steamCommunity,
          externalLinks.discord,
          externalLinks.x,
          externalLinks.playtest,
      ...
      },
      {
        '@type': 'VideoGame',
        name: 'NBA THE RUN',
        gamePlatform: ['PlayStation 5', 'Xbox Series X|S', 'Steam (PC)'],
        applicationCategory: 'Game',
        genre: ['Sports', 'Basketball', 'Arcade', 'Multiplayer'],
        numberOfPlayers: {
          minValue: 1,
          maxValue: 6,
        },
  ...
  const [multiplayerExpanded, setMultiplayerExpanded] = useState<number | null>(null)
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="px-4 py-12">
        <div className="scroll-reveal container mx-auto max-w-4xl">
          ...
          <div className="mt-4 text-center">
            <a
              href={videoFeature.youtubeUrl}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-[hsl(var(--nav-theme-light))] transition"
            >
              Watch on YouTube
      ...
      <section className="px-4 py-20 bg-white/[0.02]">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            <a
              href="#release-date"
              onClick={(event) => { event.preventDefault(); scrollToSection('release-date') }}
              className="scroll-reveal group p-6 rounded-xl border border-border bg-card hover:border-[hsl(var(--nav-theme)/0.5)] transition-all duration-300 cursor-pointer text-left hover:shadow-lg hover:shadow-[hsl(var(--nav-theme)/0.1)]"
            ...
            <a
              href="#steam-playtest"
              onClick={(event) => { event.preventDefault(); scrollToSection('steam-playtest') }}
              className="scroll-reveal group p-6 rounded-xl border border-border bg-card hover:border-[hsl(var(--nav-theme)/0.5)] transition-all duration-300 cursor-pointer text-left hover:shadow-lg hover:shadow-[hsl(var(--nav-theme)/0.1)]"
            ...
            <a
              href="#platforms"
              onClick={(event) => { event.preventDefault(); scrollToSection('platforms') }}
              className="scroll-reveal group p-6 rounded-xl border border-border bg-card hover:border-[hsl(var(--nav-theme)/0.5)] transition-all duration-300 cursor-pointer text-left hover:shadow-lg hover:shadow-[hsl(var(--nav-theme)/0.1)]"
            ...
            <a
              ...
              onClick={(event) => { event.preventDefault(); scrollToSection('gameplay-trailer') }}
              className="scroll-reveal group p-6 rounded-xl border border-border bg-card hover:border-[hsl(var(--nav-theme)/0.5)] transition-all duration-300 cursor-pointer text-left hover:shadow-lg hover:shadow-[hsl(var(--nav-theme)/0.1)]"
            ...
            <a
              ...
              onClick={(event) => { event.preventDefault(); scrollToSection('gameplay-overview') }}
              className="scroll-reveal group p-6 rounded-xl border border-border bg-card hover:border-[hsl(var(--nav-theme)/0.5)] transition-all duration-300 cursor-pointer text-left hover:shadow-lg hover:shadow-[hsl(var(--nav-theme)/0.1)]"
            ...
            <a
              href="#beginner-guide"
              onClick={(event) => { event.preventDefault(); scrollToSection('beginner-guide') }}
              className="scroll-reveal group p-6 rounded-xl border border-border bg-card hover:border-[hsl(var(--nav-theme)/0.5)] transition-all duration-300 cursor-pointer text-left hover:shadow-lg hover:shadow-[hsl(var(--nav-theme)/0.1)]"
            ...
            <a
              href="#game-modes"
              onClick={(event) => { event.preventDefault(); scrollToSection('game-modes') }}
              className="scroll-reveal group p-6 rounded-xl border border-border bg-card hover:border-[hsl(var(--nav-theme)/0.5)] transition-all duration-300 cursor-pointer text-left hover:shadow-lg hover:shadow-[hsl(var(--nav-theme)/0.1)]"
            ...
            <a
              href="#knockout-tournament"
              onClick={(event) => { event.preventDefault(); scrollToSection('knockout-tournament') }}
              className="scroll-reveal group p-6 rounded-xl border border-border bg-card hover:border-[hsl(var(--nav-theme)/0.5)] transition-all duration-300 cursor-pointer text-left hover:shadow-lg hover:shadow-[hsl(var(--nav-theme)/0.1)]"
            ...
            <a
              href="#roster"
              onClick={(event) => { event.preventDefault(); scrollToSection('roster') }}
              className="scroll-reveal group p-6 rounded-xl border border-border bg-card hover:border-[hsl(var(--nav-theme)/0.5)] transition-all duration-300 cursor-pointer text-left hover:shadow-lg hover:shadow-[hsl(var(--nav-theme)/0.1)]"
            ...
            <a
              href="#best-players"
              onClick={(event) => { event.preventDefault(); scrollToSection('best-players') }}
              className="scroll-reveal group p-6 rounded-xl border border-border bg-card hover:border-[hsl(var(--nav-theme)/0.5)] transition-all duration-300 cursor-pointer text-left hover:shadow-lg hover:shadow-[hsl(var(--nav-theme)/0.1)]"
            ...
            <a
              href="#in-the-zone-abilities"
              onClick={(event) => { event.preventDefault(); scrollToSection('in-the-zone-abilities') }}
              className="scroll-reveal group p-6 rounded-xl border border-border bg-card hover:border-[hsl(var(--nav-theme)/0.5)] transition-all duration-300 cursor-pointer text-left hover:shadow-lg hover:shadow-[hsl(var(--nav-theme)/0.1)]"
            ...
            <a
              href="#controls"
              onClick={(event) => { event.preventDefault(); scrollToSection('controls') }}
              className="scroll-reveal group p-6 rounded-xl border border-border bg-card hover:border-[hsl(var(--nav-theme)/0.5)] transition-all duration-300 cursor-pointer text-left hover:shadow-lg hover:shadow-[hsl(var(--nav-theme)/0.1)]"
            ...
            <a
              href="#courts"
              onClick={(event) => { event.preventDefault(); scrollToSection('courts') }}
              className="scroll-reveal group p-6 rounded-xl border border-border bg-card hover:border-[hsl(var(--nav-theme)/0.5)] transition-all duration-300 cursor-pointer text-left hover:shadow-lg hover:shadow-[hsl(var(--nav-theme)/0.1)]"
            ...
            <a
              href="#multiplayer"
              onClick={(event) => { event.preventDefault(); scrollToSection('multiplayer') }}
              className="scroll-reveal group p-6 rounded-xl border border-border bg-card hover:border-[hsl(var(--nav-theme)/0.5)] transition-all duration-300 cursor-pointer text-left hover:shadow-lg hover:shadow-[hsl(var(--nav-theme)/0.1)]"
            ...
            <a
              href="#progression"
              onClick={(event) => { event.preventDefault(); scrollToSection('progression') }}
              className="scroll-reveal group p-6 rounded-xl border border-border bg-card hover:border-[hsl(var(--nav-theme)/0.5)] transition-all duration-300 cursor-pointer text-left hover:shadow-lg hover:shadow-[hsl(var(--nav-theme)/0.1)]"
            ...
            <a
              ...
              onClick={(event) => { event.preventDefault(); scrollToSection('system-requirements') }}
              className="scroll-reveal group p-6 rounded-xl border border-border bg-card hover:border-[hsl(var(--nav-theme)/0.5)] transition-all duration-300 cursor-pointer text-left hover:shadow-lg hover:shadow-[hsl(var(--nav-theme)/0.1)]"
      ...
      {/* Module 1: NBA The Run Release Date */}
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="scroll-reveal p-6 bg-[hsl(var(--nav-theme)/0.05)] border border-[hsl(var(--nav-theme)/0.3)] rounded-xl">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-bold text-lg">NBA The Run Release Tips</h3>
            </div>
      ...
      {/* Module 2: NBA The Run Steam Playtest */}
      <section id="steam-playtest" className="scroll-mt-24 px-4 py-20 bg-white/[0.02]">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-12 scroll-reveal">
      ...
      {/* Module 3: NBA The Run Platforms */}
      ...
      {/* Module 4: NBA The Run Gameplay Trailer */}
      <section id="gameplay-trailer" className="scroll-mt-24 px-4 py-20 bg-white/[0.02]">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-12 scroll-reveal">
          ...
          <div className="scroll-reveal p-6 bg-[hsl(var(--nav-theme)/0.05)] border border-[hsl(var(--nav-theme)/0.3)] rounded-xl">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-bold">NBA The Run Gameplay Notes</h3>
            </div>
            <ul className="space-y-2">
      ...
      {/* Module 5: NBA The Run Gameplay Overview */}
      ...
      {/* Module 6: NBA The Run Beginner Guide */}
      ...
      {/* Module 7: NBA The Run Game Modes */}
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="scroll-reveal grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {t.modules.lucidBlocksCreaturesAndEnemies.creatures.map((c: any, index: number) => (
              <div key={index} className="p-6 bg-white/5 border border-border rounded-xl hover:border-[hsl(var(--nav-theme)/0.5)] transition-colors">
                <div className="mb-3">
                  <span className={`text-xs px-2 py-1 rounded-full border ${["Hostile Enemy","Major Threat","Elite Threat"].includes(c.role) ? "bg-[hsl(var(--nav-theme)/0.15)] border-[hsl(var(--nav-theme)/0.45)] text-[hsl(var(--nav-theme-light))]" : "bg-[hsl(var(--nav-theme)/0.1)] border-[hsl(var(--nav-theme)/0.3)]"}`}>{c.role}</span>
                </div>
                <h3 className="font-bold mb-2">
      ...
      {/* Module 8: NBA The Run Knockout Tournament */}
      <section id="knockout-tournament" className="scroll-mt-24 px-4 py-20">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-12 scroll-reveal">
      ...
      {/* Module 9: NBA The Run Roster */}
      <section id="roster" className="scroll-mt-24 px-4 py-20">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-12 scroll-reveal">
      ...
      {/* Module 10: NBA The Run Best Players */}
      <section id="best-players" className="scroll-mt-24 px-4 py-20 bg-white/[0.02]">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-12 scroll-reveal">
            ...
            {t.modules.lucidBlocksBestEarlyUnlocks.priorities.map((p: any, index: number) => (
              <div key={index} className="p-6 bg-white/5 border border-border rounded-xl hover:border-[hsl(var(--nav-theme)/0.5)] transition-colors">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className={`text-xs px-2 py-1 rounded-full border ${p.priority === "Essential" ? "bg-[hsl(var(--nav-theme)/0.15)] border-[hsl(var(--nav-theme)/0.45)] text-[hsl(var(--nav-theme-light))]" : p.priority === "Very High" ? "bg-[hsl(var(--nav-theme-light)/0.15)] border-[hsl(var(--nav-theme-light)/0.45)] text-[hsl(var(--nav-theme-light))]" : "bg-[hsl(var(--nav-theme)/0.1)] border-[hsl(var(--nav-theme)/0.3)]"}`}>{p.priority}</span>
                </div>
                <h3 className="font-bold mb-2">
      ...
      {/* Module 11: NBA The Run In The Zone Abilities */}
      <section id="in-the-zone-abilities" className="scroll-mt-24 px-4 py-20">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-12 scroll-reveal">
      ...
      {/* Module 12: NBA The Run Controls */}
      ...
      {/* Module 13: NBA The Run Courts */}
      <section id="courts" className="scroll-mt-24 px-4 py-20">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-12 scroll-reveal">
          ...
          <div className="scroll-reveal grid grid-cols-1 md:grid-cols-2 gap-4">
            {t.modules.lucidBlocksSteamDeckAndController.items.map((item: any, index: number) => (
              <div key={index} className="p-6 bg-white/5 border border-border rounded-xl hover:border-[hsl(var(--nav-theme)/0.5)] transition-colors">
                ...
                <ul className="space-y-2">
                  {item.highlights.map((point: string, pointIndex: number) => (
      ...
      {/* Module 14: NBA The Run Multiplayer */}
      <section id="multiplayer" className="scroll-mt-24 px-4 py-20 bg-white/[0.02]">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-12 scroll-reveal">
          ...
          <div className="scroll-reveal space-y-3">
            {t.modules.lucidBlocksSettingsAndAccessibility.items.map((item: any, index: number) => (
              <div key={index} className="border border-border rounded-xl overflow-hidden bg-white/5">
                <button
                  onClick={() => setMultiplayerExpanded(multiplayerExpanded === index ? null : index)}
                  className="w-full flex items-center justify-between p-5 text-left hover:bg-white/5 transition-colors"
                >
                  <span className="font-semibold">{item.question}</span>
                  <ChevronDown className={`w-5 h-5 flex-shrink-0 transition-transform ${multiplayerExpanded === index ? "rotate-180" : ""}`} />
                </button>
                <div className={`grid transition-[grid-template-rows] duration-300 ${multiplayerExpanded === index ? "grid-rows-[1fr]" : "grid-rows-[0fr]"}`}>
      ...
      {/* Module 15: NBA The Run Progression */}
      <section id="progression" className="scroll-mt-24 px-4 py-20">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-12 scroll-reveal">
              ...
              <div key={index} className="p-6 bg-white/5 border border-border rounded-xl hover:border-[hsl(var(--nav-theme)/0.5)] transition-colors">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-1">{item.reward_type}</p>
                  </div>
                </div>
                <p className="text-sm text-muted-foreground mb-4">{item.description}</p>
                <p className="text-xs text-[hsl(var(--nav-theme-light))] font-medium mb-3">
                  {item.unlock_path}
                </p>
                <ul className="space-y-2">
                  {item.examples.map((example: string, exampleIndex: number) => (
                    <li key={exampleIndex} className="flex items-start gap-2 text-xs text-muted-foreground">
                      <Check className="w-3.5 h-3.5 text-[hsl(var(--nav-theme-light))] mt-0.5 flex-shrink-0" />
                      <span>{example}</span>
                    </li>
                  ))}
      ...
      {/* Module 16: NBA The Run System Requirements */}
      <section id="system-requirements" className="scroll-mt-24 px-4 py-20 bg-white/[0.02]">
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="scroll-reveal overflow-x-auto mb-8 rounded-xl border border-border bg-white/5">
            <table className="w-full min-w-[900px] text-sm">
              <thead className="bg-[hsl(var(--nav-theme)/0.12)]">
                <tr>
                  <th className="text-left px-4 py-3 font-semibold">Category</th>
                  <th className="text-left px-4 py-3 font-semibold">PC Minimum</th>
                  <th className="text-left px-4 py-3 font-semibold">PC Recommended</th>
                  <th className="text-left px-4 py-3 font-semibold">Platform Notes</th>
                </tr>
              </thead>
              <tbody>
                {t.modules.lucidBlocksCrashFixAndTroubleshooting.rows.map((row: any, index: number) => (
                  <tr key={index} className="border-t border-border/70">
                    <td className="px-4 py-3 font-medium">{row.category}</td>
                    <td className="px-4 py-3 text-muted-foreground">{row.pc_minimum}</td>
                    <td className="px-4 py-3 text-muted-foreground">{row.pc_recommended}</td>
                    <td className="px-4 py-3 text-muted-foreground">{row.platform_notes}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div className="scroll-reveal p-6 bg-[hsl(var(--nav-theme)/0.08)] border border-[hsl(var(--nav-theme)/0.35)] rounded-xl">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-bold text-[hsl(var(--nav-theme-light))] mb-2">Need more NBA The Run setup help?</h3>
                <p className="text-sm text-muted-foreground mb-3">{t.modules.lucidBlocksCrashFixAndTroubleshooting.supportPrompt}</p>
                <div className="flex flex-wrap gap-3">
                  <a href={externalLinks.discord} target="_blank" rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[hsl(var(--nav-theme)/0.1)] border border-[hsl(var(--nav-theme)/0.3)] text-sm hover:bg-[hsl(var(--nav-theme)/0.2)] transition-colors">
                    <MessageCircle className="w-4 h-4" /> {t.modules.lucidBlocksCrashFixAndTroubleshooting.supportLinks[0]} <ExternalLink className="w-3 h-3" />
                  </a>
                  <a href={externalLinks.steamCommunity} target="_blank" rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[hsl(var(--nav-theme)/0.1)] border border-[hsl(var(--nav-theme)/0.3)] text-sm hover:bg-[hsl(var(--nav-theme)/0.2)] transition-colors">
                    {t.modules.lucidBlocksCrashFixAndTroubleshooting.supportLinks[1]} <ExternalLink className="w-3 h-3" />
                  </a>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <a
                    href={externalLinks.steamCommunity}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-muted-foreground hover:text-[hsl(var(--nav-theme-light))] transition"
                  >
